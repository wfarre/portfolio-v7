...
const Marquee = () => {
  ...
  return (
    ...
    >
      <div className="absolute bg-gradient-to-r from-black from-50% to-transparent to-70% h-50 w-28  top-0 left-0 z-10"></div>
      <div className="absolute bg-gradient-to-l from-black from-50% to-transparent to-70% h-50 w-28  top-0 right-0 z-10"></div>

      <ul
        ref={scrollMarquee}
        className="flex items-start opacity-10 font-title w-fit text-[200px] leading-[200px]"
      >
